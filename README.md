## Overview
**chordsheets** aims to provide a solution for storing and rendering transposable chordsheets.  Songs are stored in a key-agnostic format, which can then be displayed in an arbitrary key on demand.  It is built on the MEAN stack, a full-stack JavaScript framework consisting of [MongoDB](http://www.mongodb.org/), [Node.js](http://www.nodejs.org/), [Express](http://expressjs.com/), and [AngularJS](http://angularjs.org/), and generated with [MEAN.js](http://meanjs.org/).
